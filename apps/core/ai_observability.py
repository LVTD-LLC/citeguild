...
class PrivacySafeSpanProcessor(SpanProcessor):
    """Remove exception payloads before forwarding AI spans to PostHog."""
...
def configure_ai_observability() -> None:
    """Export content-free Pydantic AI performance traces when explicitly enabled."""
    ...
    try:
        ...
        if provider is not None:
            try:
                ...
                pass
        logger.error(
            "PostHog AI observability setup failed",
