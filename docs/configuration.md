...
| Domain Rating | `AHREFS_API_KEY`, `AHREFS_DOMAIN_RATING_TIMEOUT_SECONDS` | Optional free Ahrefs enrichment. New sites are queued after commit; a named daily sweep refreshes successful values after 30 days. Missing credentials disable requests without blocking site creation or indexing. |
